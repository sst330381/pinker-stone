...
public class QQweiboRecieveHandle : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        string jsonResult = request.SyncRequest(url, "GET", oauthkey, new System.Collections.Generic.List<QWeiboSDK.Parameter>(), null);
        System.Web.Script.Serialization.JavaScriptSerializer jss = new System.Web.Script.Serialization.JavaScriptSerializer();
        MODEL.Helper.Qweiboinfo Qwuinfo = jss.Deserialize<MODEL.Helper.Qweiboinfo>(jsonResult);
        context.Response.Redirect("/Account/MembershipHandler.ashx?openid=" + context.Request.QueryString["openid"] +
                "&&nickname=" + Qwuinfo.data.nick + "&&opentype=" + MODEL.OpenType.qqwbuser);
    }
